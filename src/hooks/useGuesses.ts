...
export function useGuesses(dayString: string, storageKey = "guesses_round1"): [Guess[], (guess: Guess) => void, () => void] {
  const [guesses, setGuesses] = useState<Guess[]>(loadAllGuesses(storageKey)[dayString] ?? []);
